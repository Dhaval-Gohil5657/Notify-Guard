...
class AppColors {
  ...
  static const Color securityCategory = Color(0xFFE65100); // Deep Orange for Security
  static const Color emergencyCategory = Color(0xFFC62828); // Deep Red for Emergency
